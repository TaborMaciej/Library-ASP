        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdresIDAdres = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nazwa = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IDWojewodztwo = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    WojewodztwoIDWojewodztwo = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IDWydawnictwo = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IDGatunek = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GatunekIDGatunek = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    WydawnictwoIDWydawnictwo = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IDMiasto = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MiastoIDMiasto = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
